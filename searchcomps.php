                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li>
                                <a href="searchcomps.php" class="active-sub">Compounds</a>
                            </li>
                            <li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-12">
                            ...
                            <form action="searchcomps.php" method="post">
                                <table>
                                    <tr>
                                        <th>Parameter</th>
                                        <th>Value</th>
                                    ...
                                    <tr>
                                        <td>Max Results</td>
                                        <td><input type="text" name="resultMax"/></td>
                                    </tr>
                                    <tr>
                                        <td>Max Atoms</td>
                                        <td><input type="text" name="natmax"/></td>
                                    </tr>
                                    <tr>
                                        <td>Min Atoms</td>
                                        <td><input type="text" name="natmin"/></td>
                                    </tr>
                                    <tr>
                                        <td>Max Carbons</td>
                                        <td><input type="text" name="ncrmax"/></td>
                                    </tr>
                                    <tr>
                                        <td>Min Carbons</td>
                                        <td><input type="text" name="ncrmin"/></td>
                                    </tr>
                                    <tr>
                                        <td>Max Nitrogens</td>
                                        <td><input type="text" name="nntmax"/></td>
                                    </tr>
                                    <tr>
                                        <td>Min Nitrogens</td>
                                        <td><input type="text" name="nntmin"/></td>
                                    </tr>
                                    <tr>
                                        <td>Max Oxygens</td>
                                        <td><input type="text" name="noxmax"/></td>
                                    </tr>
                                    <tr>
                                        <td>Min Oxygens</td>
                                        <td><input type="text" name="noxmin"/></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="text-align: right;"><input type="submit" value="List"/>
                                        </td>
                                    </tr>
                                </table>
                            </form>
                            ...
                            if ($setpar) {
                                ...
                                if (!empty($conditions)) {
                                    ...
                                    echo "No Query Given or No Results\n";
                                }
                            }
                            ?>
